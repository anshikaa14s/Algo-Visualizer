...
import { Mail, Lock, LogIn, ShieldAlert, Cpu, LogOut, Terminal } from 'lucide-react';
        ...
        {user ? (
          ...
          <>
            ...
            <form onSubmit={handleEmailLogin} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full flex items-center justify-center gap-2 px-4 py-3.5 mt-2 rounded-xl bg-gradient-to-r from-brand-primary to-brand-secondary text-black font-bold tracking-wide transition-all cursor-pointer shadow-lg shadow-brand-glow text-sm hover:scale-[1.02]"
              >
